    ...
    <div className="w-[95%] max-w-xl mx-auto   min-h-screen">
      <div className=" rounded-lg s overflow-hidden">
        ...
        <div className="">
          ...
          {/* Schedule Grid */}
          <div className="space-y-4 liquid-glass p-2">
            {Object.entries(dayNames).map(([day, dayName]) => (
              <div key={day} className="liquid-glass-effect p-2 rounded-xl ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 text-sm">
              {Object.entries(dayNames).map(([day, dayName]) => (
                <div key={day} className="flex justify-between">
                  ...
                  <span
                    className={
                      schedule[day].closed ? "text-red-600" : "text-green-600"
                    }
                  >
                    {schedule[day].closed
                      ? "Closed"
          ...
          <div className="mt-6 text-sm text-gray-600 bg-gray-50 rounded-lg p-4">
            ...
            <ul className="space-y-1">
              ...
              <li>
                • Use "Copy to All" to apply one day's schedule to all days
              </li>
              <li>• Click "Save Changes" to update the pharmacy schedule</li>
              <li>
                • Use "Reset to Default" to restore the original schedule (8:00
                AM - 6:00 PM, closed Sunday)
              </li>
            </ul>
          </div>
        </div>
