      ...
      <div className="container mx-auto px-[2rem] lg:px-[5rem]  relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center ">
          ...
          <div className="text-white space-y-8">
            ...
            <Link href={'/purpose'} className='bg-black hover:bg-black/90 lg:hidden  text-white mx-auto justify-center flex text-sm py-3.5 rounded-lg gap-2 items-center cursor-pointer'>
              <Sparkle size={18} />
              Get Started</Link>
