...
function DrugCard({ drug }: { drug: DrugType }) {
  return (
    <Link href={`/pharmacy/drugs/${drug.id}`}>
      <article className="w-sm mt-8 shadow-md  hover:bg-gray-50 border text-sm mx-auto justify-between flex gap-2 items-center border-gray-300 p-4 rounded cursor-pointer">
        <div>
